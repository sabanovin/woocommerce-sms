...
$hook = array(
    ...
    'description' => array(
        ...
        'persian' => 'پیامک  اولین اخطار پرداخت فاکتور'
    ),
    'type' => 'client',
    'extra' => '',
    'defaultmessage' => '{firstname} عزیز , این پیامک اولین اخطار یادآوری صورت حساب شما میباشد . لطفا نسبت به پرداخت آن اقدام فرمایید .',
