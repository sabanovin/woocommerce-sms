...
$hook = array(
    ...
    'description' => array(
        ...
        'persian' => 'پیامک ایجاد صورتحساب'
    ),
    'type' => 'client',
    'extra' => '',
    'defaultmessage' => '{firstname} عزیز , صورتحساب جدیدی به ارزش {total} با شماره فاکتور {invoiceid} برای شما ایجاد شده . لطفا نسبت به پرداخت آن تا قبل از تاریخ {duedate} اقدام فرمایید .',
