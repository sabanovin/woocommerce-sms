...
$hook = array(
    ...
    'description' => array(
        ...
        'persian' => 'پیامک سومین اخطار پرداخت فاکتور'
    ),
    'type' => 'client',
    'extra' => '',
    'defaultmessage' => '{firstname} عزیز , این سومین و آخرین پیامک یادآوری پرداخت صورتحساب شما میباشد . لطفا نسبت به پرداخت آن اقدام فرمایید .',
