...
$hook = array(
    ...
    'description' => array(
        ...
        'persian' => 'پیامک یاد آوری تمدید دامنه'
    ),
    'type' => 'client',
    'extra' => '15',
    'defaultmessage' => '{firstname} عزیز , دامنه شما با نام {domain} در {x} روز آینده منقضی خوهد شد . لطفا نسبت به تمدید آن اقدام فرمایید .',
