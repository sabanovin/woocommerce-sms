...
$hook = array(
    ...
    'description' => array(
        ...
        'persian' => 'پیامک دومین اخطار پرداخت صورتحساب'
    ),
    'type' => 'client',
    'extra' => '',
    'defaultmessage' => '{firstname} عزیز , این دومین پیامک یادآوری پرداخت صورتحساب شما میباشد . لطفا نسبت به پرداخت آن اقدام فرمایید .',
